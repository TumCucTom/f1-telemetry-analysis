...
class F1DynamicRacingLine:
    ...
    def plot_dynamic_racing_line(self, driver1: str, driver2: str, save_path: Optional[str] = None) -> None:
        ...
        # Create a colormap: blue for driver1 ahead, red for driver2 ahead
        colors = ['blue' if delta >= 0 else 'red' for delta in time_deltas]
...
def main():
    ...
    # Create the dynamic racing line plot
    try:
